...
pub const TREE_SITTER_LANGUAGE_VERSION: u32 = 1019;
pub const TREE_SITTER_MIN_COMPATIBLE_LANGUAGE_VERSION: u32 = 13;
pub type TSStateId = u32;
...
unsafe extern "C" {
    #[doc = " Set the context that the parser gives to the external scanner (tree-sitter-cpp fork)."]
    pub fn ts_parser_set_scanner_context(self_: *mut TSParser, context: *const ::core::ffi::c_void);
}
unsafe extern "C" {
    #[doc = " Get the context that the parser gives to the external scanner, or NULL (tree-sitter-cpp fork)."]
    pub fn ts_parser_scanner_context(self_: *const TSParser) -> *const ::core::ffi::c_void;
}
unsafe extern "C" {
