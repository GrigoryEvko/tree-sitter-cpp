...
static const char *const GRAMMAR_KEYWORDS[] = {
    ...
    "_Nullable_result", "_Static_assert", "__alignof", "__alignof__", "__asm", "__asm__", "__attribute", "__attribute__",
    "__based",
    "__builtin_available", "__builtin_offsetof", "__builtin_va_arg", "__cdecl", "__clrcall", "__complex__",
    ...
    "__inline", "__inline__",
    "__interface", "__label__", "__leave", "__nonnull", "__nullable", "__real", "__real__",
    "__regcall", "__restrict", "__restrict__", "__signed", "__signed__", "__sptr", "__stdcall", "__thiscall",
    "__thread", "__try", "__typeof", "__typeof__", "__typeof_unqual__", "__unaligned", "__uptr", "__vectorcall",
    "__volatile", "__volatile__", "_alignof", "_unaligned", "abstract", "alignas", "alignof", "and", "and_eq",
